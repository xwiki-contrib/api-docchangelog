...
/**
 * Register the document changelog table.
 *
 * @version $Id: f9ed06c92322e4b3ba6505fc7b87ea7a142d246d $
 */
@Component
@Named("DocChangelogInitializer")
@Singleton
public class DocChangelogInitializer implements EventListener
{
    @Inject
    ...
    {
        return "Document Changelog Initializer";
    }

    @Override
    public void onEvent(Event event, Object source, Object data)
    {
        this.sessionFactory.getConfiguration().addInputStream(getMappingFile("docchangelog.hbm.xml"));
    }
